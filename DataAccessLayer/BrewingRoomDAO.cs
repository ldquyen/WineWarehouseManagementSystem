...
namespace DataAccessLayer
{
    public class BrewingRoomDAO : SingletonBase<BrewingRoomDAO>
    {
        ...
        public async Task<List<BrewingRoom>> GetBrewingByRoomNameAsync(string roomName)
        {
            return await _context.BrewingRooms.Where(br => br.RoomName == roomName).ToListAsync();
        }
