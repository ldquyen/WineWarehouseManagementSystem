...
namespace Repositories.Repository
{
    public class BrewingRoomRepository : IBrewingRoomRepository
    {
        ...
        public async Task<List<BrewingRoom>> GetBrewingsByRoomNameAsync(string roomName) => await _roomDAO.GetBrewingsByRoomNameAsync(roomName);
        public async Task<BrewingRoom> GetBrewingByRoomNameAsync(string roomName) => await _roomDAO.GetBrewingByRoomNameAsync(roomName);
